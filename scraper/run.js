...
// limitation: every fixture in a weekend round activates independently,
// 12 hours before ITS OWN kickoff — never earlier, and never all at once
// for the whole round. That stays true even when the prediction formula
// itself changes. For the rare occasion a formula change needs to reach
// fixtures that were already researched under the old formula, without
// waiting for each one's own window, use the separate, manually-triggered
